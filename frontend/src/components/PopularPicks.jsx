...
// const PopularPicks = ({ onAdd }) => {
//   return (
//     <div className="popular-picks">
//       <h3 className="popular-title">Popular picks to get started</h3>
//       <div className="popular-grid">
//         {POPULAR_PICKS.map((stock) => (
//           <button
//             key={stock.symbol}
//             className="popular-chip"
//             onClick={() => onAdd(stock.symbol, "casual", stock.name)}
//           >
//             <span className="popular-name">{stock.name}</span>
//             <span className="popular-symbol">{stock.symbol}</span>
//             <span className="popular-plus">+</span>
//           </button>
//         ))}
//       </div>
//     </div>
